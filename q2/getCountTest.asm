...
int main(void){
  ...
  70:	50                   	push   %eax
  71:	68 d0 07 00 00       	push   $0x7d0
  76:	6a 01                	push   $0x1
  78:	e8 d3 03 00 00       	call   450 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	e9 8f fe ff ff       	jmp    498 <printf+0x48>
          s = "(null)";
 609:	bb e5 07 00 00       	mov    $0x7e5,%ebx
        while(*s != 0){
