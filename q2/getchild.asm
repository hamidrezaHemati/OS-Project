...
_getchild:     file format elf32-i386
...
int parent = getpid();
  13:	e8 7a 03 00 00       	call   392 <getpid>
...
int pid1 = fork();
  2a:	e8 db 02 00 00       	call   30a <fork>
...
if(pid1 < 0)
  ...
  3b:	78 2f                	js     6c <main+0x6c>
    printf(1, "first fork didnt work \n");
if(pid2 < 0)
  3d:	85 c0                	test   %eax,%eax
  3f:	78 44                	js     85 <main+0x85>
    printf(1, "second fork didnt work \n");
printf(1, "%d \t %d\n", getpid(), getppid());
  41:	e8 74 03 00 00       	call   3ba <getppid>
  46:	89 c6                	mov    %eax,%esi
  48:	e8 45 03 00 00       	call   392 <getpid>
  4d:	56                   	push   %esi
  4e:	50                   	push   %eax
  4f:	68 12 08 00 00       	push   $0x812
  54:	6a 01                	push   $0x1
  56:	e8 15 04 00 00       	call   470 <printf>

if(getpid() == parent){
  5b:	e8 32 03 00 00       	call   392 <getpid>
  60:	83 c4 10             	add    $0x10,%esp
  63:	39 d8                	cmp    %ebx,%eax
  65:	74 31                	je     98 <main+0x98>
if(pid2>0){
    printf(1, "children = %d\n", getchildren());
    //printf(1, "children = %d\n", getchildren());
    wait();
...
exit();
  67:	e8 a6 02 00 00       	call   312 <exit>
    printf(1, "first fork didnt work \n");
  6c:	51                   	push   %ecx
  6d:	51                   	push   %ecx
  6e:	68 e1 07 00 00       	push   $0x7e1
  73:	6a 01                	push   $0x1
  75:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  78:	e8 f3 03 00 00       	call   470 <printf>
  7d:	83 c4 10             	add    $0x10,%esp
  80:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  83:	eb b8                	jmp    3d <main+0x3d>
    printf(1, "second fork didnt work \n");
  85:	52                   	push   %edx
  86:	52                   	push   %edx
  87:	68 f9 07 00 00       	push   $0x7f9
  8c:	6a 01                	push   $0x1
  8e:	e8 dd 03 00 00       	call   470 <printf>
  93:	83 c4 10             	add    $0x10,%esp
  96:	eb a9                	jmp    41 <main+0x41>
    printf(1, "checking orginal parent id is %d\n", parent);
  98:	50                   	push   %eax
  99:	53                   	push   %ebx
  9a:	68 2c 08 00 00       	push   $0x82c
  9f:	6a 01                	push   $0x1
  a1:	e8 ca 03 00 00       	call   470 <printf>
    printf(1, "children = %d\n", getchildren());
  a6:	e8 17 03 00 00       	call   3c2 <getchildren>
  ab:	83 c4 0c             	add    $0xc,%esp
  ae:	50                   	push   %eax
  af:	68 1b 08 00 00       	push   $0x81b
  b4:	6a 01                	push   $0x1
 ...
 3d9:	85 d2                	test   %edx,%edx
{
 ...
 407:	f7 f1                	div    %ecx
 409:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb 50 08 00 00       	mov    $0x850,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 67d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 67f:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 684:	5b                   	pop    %ebx
 685:	5e                   	pop    %esi
 686:	5f                   	pop    %edi
 ...
 696:	72 ce                	jb     666 <free+0x26>
{
 ...
 6b7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ba:	a3 04 0b 00 00       	mov    %eax,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 15 04 0b 00 00    	mov    0xb04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 47                	jae    768 <malloc+0x98>
    ...
    if(p == freep)
 721:	39 05 04 0b 00 00    	cmp    %eax,0xb04
 ...
 746:	e8 f5 fe ff ff       	call   640 <free>
  return freep;
 74b:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 774:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 777:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 ...
 789:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 04 0b 00 00 08 	movl   $0xb08,0xb04
 797:	0b 00 00 
 79a:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 7a1:	0b 00 00 
    base.s.size = 0;
 7a4:	b8 08 0b 00 00       	mov    $0xb08,%eax
 7a9:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 7b0:	00 00 00 
